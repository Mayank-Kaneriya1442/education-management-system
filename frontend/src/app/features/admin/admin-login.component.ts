        ...
        <div class="container">
          <div class="auth-card reveal-on-scroll">
            <div class="auth-header">
              <h2 class="auth-title"><span style="margin-right: 8px">🛡️</span>Admin Portal</h2>
              <p class="auth-subtitle">Access the management dashboard.</p>
            </div>
            ...
            <form [formGroup]="form" (ngSubmit)="submit()">
              <div class="form-group">
                ...
                <input class="form-control" formControlName="email" type="email" placeholder="admin@example.com" />
              </div>
              <div class="form-group">
