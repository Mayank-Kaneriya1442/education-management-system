    ...
    <div class="page-container">
      <header class="page-header">
        <div class="header-content">
          <h1><span style="margin-right: 12px">🎓</span>Student Management</h1>
        ...
        <div class="form-card">
          ...
          <form [formGroup]="form" (ngSubmit)="create()">
            ...
            <div class="form-actions">
              <button class="btn btn-primary" [disabled]="form.invalid || formLoading()">Create Student</button>
            </div>
          </form>
        </div>
...
export class StudentManagementComponent {
  ...
  load() {
    ...
    this.error.set(null);
    this.api.list('student').subscribe({
      next: (r) => {
        this.users.set(r.users);
        this.loading.set(false);
      },
      error: (e) => {
        this.error.set(e?.error?.message ?? 'Failed to load students');
        this.loading.set(false);
      }
    });
  }
  ...
  create() {
    ...
    this.api
      .create({ name: v.name!, email: v.email!, phone: v.phone ?? '', password: v.password!, role: 'student' })
      .subscribe({
        next: () => {
        ...
        error: (e) => {
          this.formLoading.set(false);
          this.formError.set(e?.error?.message ?? 'Failed to create student');
        }
      });
  }
